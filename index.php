			...
			<div class="row">
				<?php
					for($i = 0; $i < count($products); $i++){
						...
						echo '				<p>';
						echo '					<a href="javascript:addProduct('.$products[$i]['id'].')" class="icon" id="fetchData"><i class="icon-shopping-cart"></i></a>';
						echo '				</p>';
						echo '			</div>';
						echo '		</div>';
						echo '		<div class="desc">';
		...
		<div class="container">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">Cart</div>
                    ...
                    <?php
                        for($i = 0; $i < count($products); $i++){
                            echo '<li class="list-group-item">'.$products[$i]['name'].'</li>';
                        }
                    ?>
                    </ul>
                </div>				
